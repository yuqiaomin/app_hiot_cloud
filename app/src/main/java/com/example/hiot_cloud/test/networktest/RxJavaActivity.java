...
//    private EditText etRegister;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etEmail = findViewById(R.id.et_rxjava_email);
//        etRegister = findViewById(R.id.et_rxjava_register);
        //登录
        Button btnLogin = findViewById(R.id.btn_rxjava_login);
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                login("yuqiaominzs","abc123");
            }
        });
        //用户信息
    ...
    private void register() {
        ...
        userBean.setUsername("yuqiaominzaa");
        userBean.setEmail("0123abc@qq.com");
                ...
                .subscribe(new Observer<ResultBase<UserBean>>() {
                    ...
                    public void onNext(ResultBase<UserBean> resultBase) {
                        if (resultBase != null && resultBase.getData() != null){
                            ...
                            String str = String.format("用户：%s,密码：%s,邮箱：%s,状态：%s",
                                    userBean.getUsername(),userBean.getPassword(),
                                    userBean.getEmail(),userBean.getUserType()
                            );
                            //todo
                ...
                .subscribe(new Observer<ResultBase<String>>() {
                    ...
                    public void onNext(ResultBase<String> resultBase) {
                        if (resultBase != null && resultBase.getData() != null){
                            ...
                            String str = String.format("新邮箱：%s",string);
                            //todo
                            Toast.makeText(RxJavaActivity.this, str, Toast.LENGTH_SHORT).show();
                        } else if (resultBase != null && !TextUtils.isEmpty(resultBase.getMsg()))
                        {
